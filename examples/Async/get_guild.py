"""
get_guild.py
Sample script to get guild information from Comlink using the async client
"""
...
async def main():
    ...
    async with SwgohComlinkAsync() as comlink:
        ...
        player profile. In the example below, we'll make a call to the get_player() method first and then use the
        guild_id from the response to call the get_guild() method.
        """
        ...
        such as recent raid or event result, then the 'include_recent_guild_activity_info' argument in the method
